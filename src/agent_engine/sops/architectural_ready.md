...
2. 详细阅读关联的 User Story 文档以及当前项目的代码结构。
3. 在 `docs/architecture/` 或 `docs/adr/` 目录下创建或更新 Markdown 架构决策记录 (ADR) 或设计文档。
4. 文档内需明确：子系统边界、核心业务路径、技术选型，以及替代方案的权衡分析。
5. 文档编写完成后，调用 `submit_task_result` 提交工作，推动任务进入审查。
