...
class TestDispatchJob:
    ...
    async def test_mark_running(self, instance, session_id, expected) -> None:
    ...
    async def test_mark_completed(self, instance, expected) -> None:
    ...
    async def test_mark_failed(self, instance, reason, expected) -> None:
